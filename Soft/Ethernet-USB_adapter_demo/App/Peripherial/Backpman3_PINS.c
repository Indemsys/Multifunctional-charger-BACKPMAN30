...
const T_IO_pins_configuration BACKPMAN3_pins_conf[] =
{
  ...
  { GPIOE,  13,        GPIO,  ALT00,  SPD_L, OUT_PP, PUPD_DIS, 0 }, // DCDC_MODE                           PE13     K6    ADD=()  AF0=(-)  AF1=(TIM1_CH3)  AF2=(-)  AF3=(DFSDM1_CKIN5)  AF4=(-)  AF5=(SPI4_MISO)  AF6=(-)  AF7=(-)  AF8=(-)  AF9=(-)  AF10=(SAI2_FS_B)  AF11=(-)  AF12=(FMC_D10/FMC_DA10)  AF13=(COMP2_OUT)  AF14=(LCD_DE)
...
{
  if (val != 0) GPIOE->BSRR  = BIT(13);
  else GPIOE->BSRR  = BIT(13)<< 16;
}
