...
uint8_t       usb_mem_regular[USBX_HOST_REGULAR_MEMORY_SIZE]       @ "SRAM2"; // Область для кэшируемой динамической памяти
uint8_t       usb_mem_cache_safe[USBX_HOST_CACHE_SAFE_MEMORY_SIZE] @ "SRAM2"; // Область для некэшируемой динамической памяти
