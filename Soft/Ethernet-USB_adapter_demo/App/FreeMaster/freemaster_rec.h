...
#define FMSTR_REC_TRG_F_ABOVE           0x10    /* Recorder trigger configuration - trigger is ready_to_send for threshold above results */
#define FMSTR_REC_TRG_F_BELOW           0x20    /* Recorder trigger configuration - trigger is ready_to_send for threshold below results */
#define FMSTR_REC_TRG_F_LEVEL           0x40    /* Recorder trigger configuration - trigger is level ready_to_send, otherwise edge */
...
typedef struct
{
    ...
    FMSTR_SIZE8 varCount;       /* number of ready_to_send recorder variables */
} FMSTR_REC_CFG;
