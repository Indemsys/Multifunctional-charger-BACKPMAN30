...
//#define EN_USB_LOG // Раскомментировать если нужен лог выпонения некторых функций USB. Использовался при исследовании работы USB CDC ECM HOST
  #ifdef EN_USB_LOG
    #define      USBLOG(...)    LOGs(__FUNCTION__, __LINE__, SEVERITY_RED, ##__VA_ARGS__);
  #else
    #define      USBLOG(...)
  #endif
