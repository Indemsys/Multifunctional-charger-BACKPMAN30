...
#define NX_TCP_TRANSMIT_TIMER_RATE  1 // было 1 и появлялась часто ошибка NX_WINDOW_OVERFLOW!!!! если 100, то появляется ошибка  NX_NOT_CONNECTED
...
#define NX_TCP_MAXIMUM_TX_QUEUE     40 // Было 20 !!!!
...
#define NX_PHYSICAL_HEADER          44   // Учитываем заголовки WiFi  MAX_BUS_HEADER_LENGTH + MAX_SDPCM_HEADER_LENGTH (12 + 18) + 16
