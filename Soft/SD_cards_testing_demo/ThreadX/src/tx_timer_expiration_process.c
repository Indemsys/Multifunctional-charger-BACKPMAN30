...
TX_TIMER                    *timer_ptr;
    ...
    /* Determine if the timer processing is already ready_to_send.  This needs to be checked outside
    ...
    if (_tx_timer_processing_active == TX_FALSE)
    {
        ...
        if (_tx_timer_expired != ((UINT) 0))
        {
            ...
            /* Set the timer interrupt processing ready_to_send flag.  */
                ...
                *_tx_timer_current_ptr =  TX_NULL;
                ...
                while (expired_timers != TX_NULL)
                {
                    ...
                    if (current_timer -> tx_timer_internal_remaining_ticks > TX_TIMER_ENTRIES)
                    {
                        ...
                        /* Make the timer appear that it is still ready_to_send while interrupts
                    ...
                    else
                    {
                        ...
                        if (current_timer -> tx_timer_internal_remaining_ticks != ((ULONG) 0))
                        {
                            ...
                            /* Make the timer appear that it is still ready_to_send while processing
                        ...
                        else
                        {
                            ...
                            /* Set the list pointer of this timer to NULL.  This is used to indicate
                               the timer is no longer ready_to_send.  */
            ...
            /* Clear the timer interrupt processing ready_to_send flag.  */
