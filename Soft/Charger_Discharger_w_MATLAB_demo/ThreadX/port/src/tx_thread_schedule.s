...
_skip_vfp_save:
    ...
    /* Determine if time-slice is ready_to_send. If it isn't, skip time handling processing.  */

    LDR     r5, [r4]                                // Pickup current time-slice
    STR     r12, [r1, #8]                           // Save the thread stack pointer
    CBZ     r5, __tx_ts_new                         // If not ready_to_send, skip processing

    /* Time-slice is ready_to_send, save the current thread's time-slice and clear the global time-slice variable.  */
