...
static uint8_t DevFrameWorkDesc_FS[USBD_FRAMEWORK_MAX_DESC_SZ] @ "DTCM";
...
#pragma data_alignment=4
static uint8_t DevFrameWorkDesc_HS[USBD_FRAMEWORK_MAX_DESC_SZ] @ "DTCM";
...
*/
#pragma data_alignment=4
UCHAR USBD_string_framework[USBD_STRING_FRAMEWORK_MAX_LENGTH];
