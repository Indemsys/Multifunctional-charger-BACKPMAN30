...
uint32_t  smpl_enc_a    @ "DTCM";
uint32_t  smpl_enc_b    @ "DTCM";
uint32_t  smpl_enc_sw   @ "DTCM";


T_backpman3_inputs          inp       @ "DTCM";
T_backpman3_inputs          inp_prev  @ "DTCM";
T_backpman3_inputs_flags    inp_flags @ "DTCM";


T_fp_measurement_results    fp_meas @ "DTCM";

T_input_cbl BACKPMAN3_sigs_cbls[]  =
{
