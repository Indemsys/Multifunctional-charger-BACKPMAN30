...
uint8_t                 net_packet_pool_buffer[(PACKETS_IN_POOL *(PACKET_MAX_SZ + sizeof(NX_PACKET)))]; // 48960 байт. NX_PACKET - имеет размер 60 байт. Целиком пакет имеет размер 1628 байта
