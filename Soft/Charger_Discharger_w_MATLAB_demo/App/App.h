...
extern void    Delay_m7(int cnt); // Задержка на (cnt+1)*7 тактов . Передача нуля недопускается
  ...
  #define        THREAD_FTP_CLIENT_STACK_SIZE       4096
  ...
  #define        THREAD_MATLAB_STACK_SIZE           4096

  #define        THREAD_HIGHER_PRIORITY             2
  #define        THREAD_MAIN_PRIORITY               3
  #define        THREAD_APP_PRIORITY                4
  #define        THREAD_CAN_PRIORITY                5
  #define        THREAD_FREEMASTER_PRIORITY         7
  #define        THREAD_BSD_PRIORITY                8
  #define        THREAD_NET_PRIORITY                9
  #define        THREAD_FTP_CLIENT_PRIORITY         9
  #define        MQTT_TASK_PRIO                     9
  #define        VT100_TASK_PRIO                    10
  #define        THREAD_MATLAB_PRIORITY             10
...
extern T_matlab_cmd1               matlab_cmd1;
