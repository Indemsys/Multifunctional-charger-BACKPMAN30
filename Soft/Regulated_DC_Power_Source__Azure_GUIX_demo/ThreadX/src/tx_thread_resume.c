...
UINT            map_index;
    ...
    if (thread_ptr -> tx_thread_state == TX_SUSPENDED)
    {
        ...
        if (head_ptr == TX_NULL)
        {
            ...
            /* Set the ready_to_send bit to remember that the priority map has something set.  */
                ...
                else
                {
                    ...
                    if (priority < execute_ptr -> tx_thread_preempt_threshold)
                    {
                        ...
                        if (execute_ptr -> tx_thread_preempt_threshold != execute_ptr -> tx_thread_priority)
                        {
                            ...
                            /* Set the ready_to_send bit to remember that the preempt map has something set.  */
