...
UX_SLAVE_ENDPOINT                       *endpoint;
    ...
    /* If the interface to mount has a non zero alternate setting, the class is really ready_to_send with
       the endpoints ready_to_send.  If the interface reverts to alternate setting 0, it needs to have
