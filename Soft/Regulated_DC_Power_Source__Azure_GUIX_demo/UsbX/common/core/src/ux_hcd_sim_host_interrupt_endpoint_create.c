...
UINT                    interval_sim_host;
    ...
    /* Obtain a ED for this new endpoint. This ED will live as long as
       the endpoint is ready_to_send and will be the container for the TDs.  */
    ...
    /* There is activity in the periodic tree, the scheduler has to be ready_to_send all the time.  */
