...
#define FMSTR_SERIAL_DRV        FMSTR_SERIAL_MCUX_LPUART // Use serial driver for UART
...
#define FMSTR_REC_BUFF_SIZE    (1024*64)   // Built-in buffer size of recorder #0. Set to 0 to use runtime settings.

//! Recorder time base, specifies how often the recorder is called in the user app.
#define FMSTR_REC_TIMEBASE      FMSTR_REC_BASE_NANOSEC(1000000)  // 0 = "unknown"
