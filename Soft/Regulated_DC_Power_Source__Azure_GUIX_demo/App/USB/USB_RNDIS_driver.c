...
NX_TELNET_SERVER           rndis_telnet_server;
...
uint32_t RNDIS_start_network(void)
{
  ...
  TELNET_server_create(&rndis_telnet_server);
...
uint32_t RNDIS_stop_network(void)
{
  ...
  TELNET_server_delete(&rndis_telnet_server);
...
/*-----------------------------------------------------------------------------------------------------
  ...
  \param void
-----------------------------------------------------------------------------------------------------*/
void RNDIS_interface_controller(void)
{
